...
<asp:Content ID="Content2" ContentPlaceHolderID="MainContent" runat="server">
    ...
    <%--FILTROS--%>
    <h1 style="text-align:center;color:#393945;padding-bottom:15px">INGRESO DE DATOS</h1>
<form id="formIndex">
        ...
        <div class="panel-body">
            ...
            <div class="row">
                ...
                <fieldset class="form-group col-md-5">
                    ...
                    <input type="text" class="form-control" id="txtTipoProveedor" name="txtTipoProveedor" />
                </fieldset>                    
            </div>
            <div class="row">
                <fieldset class="form-group col-md-1">
    ...
    <div class="panel panel-primary">
        ...
        <div class="panel-body">
            ...
            <div class="row">
                ...
                <fieldset class="form-group col-md-5">
                    <label for="txtTefefonoContacto">Teléfono fijo</label>
                    <input type="text" class="form-control" id="txtTefefonoContacto" name="txtTefefonoContacto" />
                </fieldset>
                <fieldset class="form-group col-md-5">
        ...
        <div class="panel-body">
            <div class="row">
                ...
                <fieldset class="form-group col-md-5">
                    ...
                    <input type="text" class="form-control" id="txtCedulaRepresentante" name="txtCedulaRepresentante" />
                </fieldset>
                <fieldset class="form-group col-md-5">
                    <label for="txtRutEmpresaProveedora">RUT de la empresa proveedora</label>
                    <input type="text" class="form-control" id="txtRutEmpresaProveedora" name="txtRutEmpresaProveedora" />
                </fieldset>                    
            </div>
            <div class="row">
                <fieldset class="form-group col-md-1">
                ...
                <fieldset class="form-group col-md-5">
                    ...
                    <input type="text" class="form-control" id="txtCertificadoCuenta" name="txtCertificadoCuenta" />
                </fieldset>
                <fieldset class="form-group col-md-5">
                    <label for="txtEscrituraEmpresa">Escritura de empresa</label>
                    <input type="text" class="form-control" id="txtEscrituraEmpresa" name="txtEscrituraEmpresa" />
                </fieldset>                    
            </div>
            <div class="row">
                <fieldset class="form-group col-md-1">
                ...
                <fieldset class="form-group col-md-5">
                    ...
                    <input type="text" class="form-control" id="txtDicom" name="txtDicom" />
                </fieldset>                   
            </div>
        </div>
    </div>
